...
function ecCheckCookie()
{
    ...
    {
        $('link.rtl').remove();
        $(".ec-tools-sidebar .ec-change-rtl").removeClass('active');
    }
    ...
    else
    {
        ...
        if (themeColor != "")
        {
            ...
            $('li[data-color = "05"]').toggleClass('active').siblings().removeClass('active');
...
(function($) {
    ...
    $('.dropdown').on('show.bs.dropdown', function() {
        console.log('show.bs.dropdown event triggered');
        $(this).find('.dropdown-menu').first().stop(true, true).slideDown();
    });
    
    $('.dropdown').on('hide.bs.dropdown', function() {
        console.log('hide.bs.dropdown event triggered');
    ...
    /*----------------------------- Theme Color Change -------------------------------- */
    $('.ec-change-color').off('click', function(){
        $('link[href^="assets/css/skin-"]').remove();
        $('link.dark').remove();
        // Remove the "active" class from all color switcher elements except the one we want to set
        $('.ec-change-color li').not('[data-color="05"]').off('click');
        
        // Disable the click event on all color switcher elements
        $('.ec-change-color li').off('click');

        // Set the "skin-05.css" color stylesheet
        $("link[href='assets/css/responsive.css']").before('<link rel="stylesheet" href="assets/css/skin-05.css" rel="stylesheet">');

        // Save the color setting in a cookie
        ecCreateCookie('themeColorCookie', '05', 1);

        return false;
    });

    /*----------------------------- Theme RTL Change -------------------------------- */
    $(".ec-tools-sidebar .ec-change-rtl .ec-rtl-switch").off('click');

    /*----------------------------- Theme Dark mode Change -------------------------------- */   
    $(".ec-tools-sidebar .ec-change-mode .ec-mode-switch").off('click');

    /*----------------------------- Full Screen mode Change -------------------------------- */   
    $(".ec-tools-sidebar .ec-fullscreen-mode .ec-fullscreen-switch").off('click');
